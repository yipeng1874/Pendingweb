...
function handleHallDailyError(res, error) {
    const map = {
    ...
    if (entry)
        return fail(res, error.message, entry[0], entry[1]);
...
export const HallDailyTemplateController = {
    ...
    async getById(req, res) {
        try {
            const template = await HallDailyTemplateService.getById(req.params.id, req.identity?.scopePath, req.identity?.roleCode, t(req.query.teamOrgId) || undefined);
    ...
    async create(req, res) {
        ...
        if (!title || !teamOrgId)
            return fail(res, "HALL_TASK_REQUIRED_FIELDS", "请填写标题和所属团队", 400);
        try {
    ...
    async update(req, res) {
        try {
            const result = await HallDailyTemplateService.update(req.params.id, req.body, req.identity?.scopePath, req.identity?.roleCode, t(req.query.teamOrgId) || undefined);
    ...
    async remove(req, res) {
        try {
            const result = await HallDailyTemplateService.remove(req.params.id, req.identity?.scopePath, req.identity?.roleCode, t(req.query.teamOrgId) || undefined);
            return ok(res, result);
        }
        catch (error) {
            return handleHallDailyError(res, error);
    ...
    async copy(req, res) {
        try {
            const result = await HallDailyTemplateService.copy(req.params.id, req.userId, req.identity?.scopePath, req.identity?.roleCode, t(req.query.teamOrgId) || undefined);
            return ok(res, result);
        }
        catch (error) {
            return handleHallDailyError(res, error);
    ...
    async archive(req, res) {
        try {
            const result = await HallDailyTemplateService.archive(req.params.id, req.identity?.scopePath, req.identity?.roleCode, t(req.query.teamOrgId) || undefined);
            return ok(res, result);
        }
        catch (error) {
            return handleHallDailyError(res, error);
...
export const HallDailyAssignmentController = {
    ...
    async saveDraft(req, res) {
        ...
        if (!templateId || !teamOrgId)
            return fail(res, "HALL_TASK_REQUIRED_FIELDS", "请填写模板和团队", 400);
        try {
    ...
    async getPublishPreview(req, res) {
        try {
            const data = await HallDailyAssignmentService.getPublishPreview(req.params.id, req.identity?.scopePath, req.identity?.roleCode, t(req.query.teamOrgId) || undefined);
            return ok(res, data);
        }
        catch (error) {
            return handleHallDailyError(res, error);
    ...
    async publish(req, res) {
        ...
        if (!effectMode)
            return fail(res, "HALL_TASK_REQUIRED_FIELDS", "请指定生效方式", 400);
        try {
            const result = await HallDailyAssignmentService.publish(req.params.id, effectMode, req.identity?.scopePath, req.identity?.roleCode, t(req.body.teamOrgId) || undefined);
            return ok(res, result);
        }
        catch (error) {
            return handleHallDailyError(res, error);
    ...
    async close(req, res) {
        try {
            const result = await HallDailyAssignmentService.close(req.params.id, req.identity?.scopePath, req.identity?.roleCode, t(req.body.teamOrgId) || undefined);
            return ok(res, result);
        }
        catch (error) {
            return handleHallDailyError(res, error);
    ...
    async delete(req, res) {
        try {
            const result = await HallDailyAssignmentService.delete(req.params.id, req.identity?.scopePath, req.identity?.roleCode, t(req.query.teamOrgId) || undefined);
            return ok(res, result);
        }
        catch (error) {
            return handleHallDailyError(res, error);
